...
def mobile(request, data=None):
 if data == None:
  mobiles = Product.objects.filter(category='M')
 elif data == 'Samsung' or data == 'Nokia' or data =='Apple':
...
class ProfileView(views.View):
 ...
 def post(self,request):
  ...
  if form.is_valid():
   ...
   reg = Customer(user=cus,name=name, locality=locality,city=city,province=province,zipcode=zipcode)
   reg.save()
   messages.success(request,'Wow!! Profile has been updated successfully')
