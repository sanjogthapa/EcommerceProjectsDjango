    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('province', models.CharField(choices=[('province1', 'province1'), ('province2', 'province2'), ('province3', 'province3'), ('province4', 'province4'), ('province5', 'province5'), ('province6', 'province6'), ('province7', 'province7')], max_length=50)),
